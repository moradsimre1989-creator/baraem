...
const GROUP_PASTELS = ["pastel-green", "pastel-blue", "pastel-yellow", "pastel-purple", "pastel-pink", "pastel-orange", "pastel-green"];
...
export default function ArabicJourneyScreen({ domain, isActivityComplete, onOpenGroup, onOpenCertificate }) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 pb-16 pt-6">
      <div className="text-center mb-8">
        <div className="w-16 h-16 rounded-2xl bg-pastel-green flex items-center justify-center text-3xl mx-auto mb-3">
          {domain.icon}
        </div>
        <h1 className="text-3xl font-black text-olive-ink">{domain.title}</h1>
        <p className="text-olive-trunk mt-2 max-w-lg mx-auto">مغامرة الزيتونة اللغوية — رحلة من 7 محطات حول قصيدة الزيتونة.</p>
      </div>

      {allComplete && (
        <div className="rounded-[24px] bg-pastel-yellow p-6 text-center mb-8" style={{ boxShadow: "var(--shadow-card)" }}>
          <div className="text-5xl mb-2">🏆</div>
          <p className="text-xl font-black text-olive-ink">أحسنت! أصبحت بطل الزيتونة</p>
