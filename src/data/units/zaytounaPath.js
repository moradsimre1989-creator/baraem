/*
  ...
  بحسب **الموضوع**: من التعرّف إلى الشجرة حتى الاختبار النهائي، كما يعيشها
...
export const zaytounaPath = {
  id: "zaytouna-path",
  title: "مسار الزيتونة",
  subtitle: "رحلة واحدة من التعرّف إلى الشجرة حتى الاختبار النهائي",
  stations: [
    {
      id: "discover-tree",
      title: "أتعرّف إلى شجرة الزيتون",
      icon: "🌳",
      cover: oliveTreeFullPhoto,
      description: "من أين نبدأ؟ نتعرّف إلى الشجرة التي رافقت أجدادنا آلاف السنين.",
    ...
    },
    {
      ...
      description: "نشاهد، نغنّي، ونتعرّف إلى الآلات التي ترافق اللحن.",
